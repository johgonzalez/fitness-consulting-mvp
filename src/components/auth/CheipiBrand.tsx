...
/** Approved artwork: its original black base is preserved in both themes. */
export function CheipiBrand({ href, symbolOnly = false, className = "" }: CheipiBrandProps) {
  const content = <>
    <span className="cheipi-brand__mark" aria-hidden="true">
      <Image className="cheipi-brand__mark-image" src="/brand/cheipi/cheipi-symbol.svg" alt="" width={40} height={40} />
    </span>
