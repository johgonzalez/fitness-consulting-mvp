...
export const metadata:Metadata={title:"Encontre seu Personal | Cheipi",description:"Responda a um quiz rápido e encontre profissionais compatíveis com seu objetivo."};
